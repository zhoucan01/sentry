...
//	if ( rc_ctrl.rc.wheel>=-600 && rc_ctrl.rc.wheel<=600 && WHEEL_LAST<-600 && WHEEL_UP_TIME<30 )
//		rc_ctrl.rc.WHEEL_State = UP_SHORT_rc;
//	else if( rc_ctrl.rc.wheel<-600 && WHEEL_UP_TIME>=20 )
//		rc_ctrl.rc.WHEEL_State = UP_LONG_rc;
//	
//	//DOWN--松开时进行判断SHORT or LONG
//	if ( rc_ctrl.rc.wheel>=-600 && rc_ctrl.rc.wheel<=600 && WHEEL_LAST>600 && WHEEL_DOWN_TIME<30 )
//		rc_ctrl.rc.WHEEL_State = DOWN_SHORT_rc;
//	else if( rc_ctrl.rc.wheel>600 && WHEEL_DOWN_TIME>=20 )
//		rc_ctrl.rc.WHEEL_State = DOWN_LONG_rc;
//	
