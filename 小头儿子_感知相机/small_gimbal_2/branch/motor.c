...
{
  set_motor_current(can1_200,0,shoot_motor[0].motor_tar.set_current,shoot_motor[1].motor_tar.set_current,trig_motor.motor_tar.set_current);
//  set_motor_current(can1_200,0,shoot_motor[0].motor_tar.set_current,shoot_motor[1].motor_tar.set_current,0);
//  set_motor_current(can1_200,0,0,0,0);
//  set_motor_current(can2_200,0,0,0,0);
//  set_motor_current(can1_200,0,0,0,trig_motor.motor_tar.set_current);
}
